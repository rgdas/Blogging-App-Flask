...
st.set_page_config(page_title='InBlogging🇮🇳: A Summarised blogs📰 Portal', page_icon='./Meta/newspaper.ico')
...
def run():
    st.title("The Daily Scoop🇮🇳: Stay Informed and Empowered with the Latest Headlines📰")
